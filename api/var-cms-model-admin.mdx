---
title: "VarCMSModelAdmin Class Reference"
...
<ParamField path="regex_validators" type="Dict[str, tuple]" default="{}">
  ...
  The value for each field is a `(pattern, error_message)` tuple:
...
<ParamField path="card_buttons" type="List[Dict]" default="[]">
...
<ParamField path="custom_object_actions" type="List[Dict]" default="[]">
