...
description: "Full reference for all VAR_CMS_* Django settings: branding, authentication, dashboard cards, and developer profile for the django-var-cms Control Panel."
---
...
<ParamField path="VAR_CMS_ACCENT_COLOR" type="Optional[str]" default="None">
  ...
  The lightness component (`L%`) is automatically clamped between **45%** and **85%** to ensure readability in both light and dark contexts. The value is stored internally as a formatted `"H, S%, L%"` string after clamping.
...
<ParamField path="STATIC_URL" type="str">
...
<ParamField path="STATIC_ROOT" type="str">
