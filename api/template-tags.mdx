...
description: "All django-var-cms template tags and filters: URL helpers, var_cms_field_preview, query_transform, safe_html, get_item, index, and form layout filters."
---
...
3. **Default heuristic** — `Checkbox` and `Textarea` widgets span 12 columns (full width); all other inputs span 6 columns (half width).
