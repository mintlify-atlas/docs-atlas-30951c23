...
description: "Restrict which form fields each role can edit using role_editable_fields, while readonly_fields are excluded from the form entirely for all users."
---
