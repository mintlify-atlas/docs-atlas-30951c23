...
description: "django-var-cms is a drop-in CMS registry for Django that auto-discovers model registrations, enforces role-based permissions, and ships a glassmorphic dark UI."
---
